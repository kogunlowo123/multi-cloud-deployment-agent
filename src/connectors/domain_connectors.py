"""Multi-Cloud Deployment Agent - Domain-Specific Connectors."""
...
class TerraformCliConnector:
    """Domain-specific connector for terraform cli integration with Multi-Cloud Deployment Agent."""
...
class AwsProviderConnector:
    """Domain-specific connector for aws provider integration with Multi-Cloud Deployment Agent."""
...
class AzureProviderConnector:
    """Domain-specific connector for azure provider integration with Multi-Cloud Deployment Agent."""
...
class GcpProviderConnector:
    """Domain-specific connector for gcp provider integration with Multi-Cloud Deployment Agent."""
...
class InfracostConnector:
    """Domain-specific connector for infracost integration with Multi-Cloud Deployment Agent."""
